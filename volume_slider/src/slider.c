...
THUMB16
NEWCODE void DrawText(int font, TEXTID text, int align, int XPos, int YPos, int Width, int TextColor)
{
...
THUMB16
NEWCODE void DrawSlider(int value,
                        int max_value,
                        int rect_y1,
                        int rect_height,
                        TEXTID slider_text,
...
THUMB16
NEWCODE TEXTID percent_to_textid(int percentage)
{
	wchar_t buf[16];
...
THUMB16
NEWCODE int Slider_OnCreate(DISP_OBJ *disp)
{
...
THUMB16
NEWCODE void Slider_OnClose(DISP_OBJ *disp)
{
	DISP_OBJ_SLIDER *disp_obj = (DISP_OBJ_SLIDER *)disp;
...
THUMB16
NEWCODE void Slider_OnRedraw(DISP_OBJ *disp, int, int, int)
{
	DISP_OBJ_SLIDER *disp_obj = (DISP_OBJ_SLIDER *)disp;

	DrawSlider(disp_obj->slider_a,
	           MAX_MEDIAVOLUME,
	           YPOS_MEDIA,
	           50,
...
THUMB16
NEWCODE void Slider_OnKey(DISP_OBJ *disp, int key, int r2, int repeat, int mode)
{
	DISP_OBJ_SLIDER *disp_obj = (DISP_OBJ_SLIDER *)disp;
...
THUMB16
NEWCODE void Slider_OnLayout(DISP_OBJ *disp, void *layout)
{
	DispObject_SetLayerColor(disp, clBlack);
}

THUMB16
NEWCODE void Slider_construct(DISP_DESC *desc)
{
...
THUMB16
NEWCODE void Slider_destruct(GUI_SLIDER *gs) {}

THUMB16
NEWCODE void Slider_callback(DISP_OBJ *disp, void *msg, GUI_SLIDER *gui) {}

THUMB16
NEWCODE GUI_SLIDER *Create_Slider(VSBook *vs)
{
	GUI_SLIDER *gs = (GUI_SLIDER *)malloc(sizeof(GUI_SLIDER));
	if (!GUIObject_Create(gs,
	                      Slider_destruct,
	                      Slider_construct,
	                      &vs->book,
	                      Slider_callback,
