...
THUMB16 NEWCODE DBP_DATA *CreateData()
{
...
THUMB16 NEWCODE DBP_DATA *GetData()
{
...
THUMB16 NEWCODE void DeleteData(DBP_DATA *data)
{
    if (data)
    {
...
THUMB16 NEWCODE void SaveData(bool save, int item)
{
...
THUMB16 NEWCODE void LoadData(DBP_DATA *Data)
{
