...
THUMB16 NEWCODE void Progress_OnSelect(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    int item = ListMenu_GetSelectedItem(setbook->sub_menu);
...
THUMB16 NEWCODE void Image_OnSelect(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    int item = ListMenu_GetSelectedItem(setbook->sub_menu);
...
THUMB16 NEWCODE void Background_OnSelect(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    int item = ListMenu_GetSelectedItem(setbook->sub_menu);
...
THUMB16 NEWCODE void Additional_OnSelect(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    int item = ListMenu_GetSelectedItem(setbook->sub_menu);
...
THUMB16 NEWCODE int Text_OnMessage(GUI_MESSAGE *msg)
{
...
THUMB16 NEWCODE int Progress_OnMessage(GUI_MESSAGE *msg)
{
    switch (GUIonMessage_GetMsg(msg))
    {
    case LISTMSG_GetItem:
...
THUMB16 NEWCODE int Image_OnMessage(GUI_MESSAGE *msg)
{
...
THUMB16 NEWCODE int Background_OnMessage(GUI_MESSAGE *msg)
{
    switch (GUIonMessage_GetMsg(msg))
    {
    case LISTMSG_GetItem:
...
THUMB16 NEWCODE int Additional_OnMessage(GUI_MESSAGE *msg)
{
    switch (GUIonMessage_GetMsg(msg))
    {
    case LISTMSG_GetItem:
...
THUMB16 NEWCODE void Editor_OnBack(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    if (setbook->changed)
...
THUMB16 NEWCODE void CreateEditor(SETTINGS_BOOK *setbook, int type, int count)
{
...
THUMB16 NEWCODE int Setting_OnMessage(GUI_MESSAGE *msg)
{
    switch (GUIonMessage_GetMsg(msg))
    {
    case LISTMSG_GetItem:
...
THUMB16 NEWCODE void Setting_OnSelect(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    ...
    else if (item == ITEM_FRAME)
    {
        ...
        data->temp.y1 = data->settings.frame.pos.y,
        CreateEditor(setbook, EDIT_ICON, SUBITEM_IMG_LAST);
    }
    else if (item == ITEM_ARTIST_ICN)
    {
        ...
        data->temp.y1 = data->settings.artist_icn.pos.y,
        CreateEditor(setbook, EDIT_ICON, SUBITEM_IMG_LAST);
    }
    else if (item == ITEM_TITLE_ICN)
    {
        ...
        data->temp.y1 = data->settings.title_icn.pos.y,
        CreateEditor(setbook, EDIT_ICON, SUBITEM_IMG_LAST);
    }
    else if (item == ITEM_ALBUM_ICN)
    {
        ...
        data->temp.y1 = data->settings.album_icn.pos.y,
        CreateEditor(setbook, EDIT_ICON, SUBITEM_IMG_LAST);
    }
...
THUMB16 NEWCODE void Question_OnYes(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
...
THUMB16 NEWCODE void Question_OnNo(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    DBP_DATA *Data = GetData();
    LoadData(Data);
...
THUMB16 NEWCODE void Question_OnBack(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    FREE_GUI(setbook->question_menu);
}

THUMB16 NEWCODE void Setting_OnBack(BOOK *book, GUI *gui)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    if (setbook->changed)
    {
...
THUMB16 NEWCODE int DBPlayer_Settings_onEnter(void *data, BOOK *book)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
...
THUMB16 NEWCODE int DBPlayer_Settings_onExit(void *data, BOOK *book)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
...
THUMB16 NEWCODE int DBPlayer_Settings_onPrev(void *data, BOOK *book)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
...
THUMB16 NEWCODE int DBPlayer_Settings_onCancel(void *data, BOOK *book)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
...
THUMB16 NEWCODE void SettingBook_onClose(BOOK *book)
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)book;
    FREE_GUI(setbook->main_menu);
    FREE_GUI(setbook->sub_menu);
...
THUMB16 NEWCODE SETTINGS_BOOK *Create_DBPlayer_SettingBook()
{
    SETTINGS_BOOK *setbook = (SETTINGS_BOOK *)malloc(sizeof(SETTINGS_BOOK));
    memset(setbook, 0, sizeof(SETTINGS_BOOK));
    if (!CreateBook((BOOK *)setbook, SettingBook_onClose, &DBPlayer_Settings_Base_Page, DBPLAYER_SETTINGS_BOOKNAME, NO_BOOK_ID, NULL))
    {
        mfree(setbook);
        return NULL;
    }
...
THUMB16 NEWCODE void DBPlayer_Setting(BOOK *book, GUI *gui)
{
