...
#define VolumeControl_OnRedraw \
    ((void (*)(DISP_OBJ *, int, int, int))ADDR_VolumeControl_OnRedraw)

#define VolumeControl_OnClose \
    ((void (*)(DISP_OBJ *))ADDR_VolumeControl_OnClose)

#define pg_VolumeControl_Active_EnterEvent \
    ((int (*)(void *, BOOK *))ADDR_pg_VolumeControl_Active_EnterEvent)

#define pg_VolumeControl_Active_ExitEvent \
    ((int (*)(void *, BOOK *))ADDR_pg_VolumeControl_Active_ExitEvent)
...
static const wchar_t *VOLUME_IMGS[LAST_IMG] = {BG_PNG,
                                               CALL_PNG,
                                               MUSIC_PNG,
                                               OFF_PNG,
                                               BLOB_PNG};
