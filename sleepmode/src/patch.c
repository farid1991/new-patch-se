...
THUMB16
NEWCODE void onTimer(uint16_t timerID, LPARAM disp_obj)
{
...
THUMB16
NEWCODE void SetRefreshTimer(DISP_OBJ *disp_obj)
{
	uint16_t *timer_id = get_timer_id();
...
THUMB16
NEWCODE void DrawText(int font, TEXTID text, int align, int x1, int y1, int x2, int y2, int pen_color)
{
#if defined(DB3200) || defined(DB3210) || defined(DB3350)
...
THUMB16
NEWCODE void New_SleepMode_OnRedraw(DISP_OBJ *disp_obj, int a, int b, int c)
{
