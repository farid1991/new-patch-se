...
// DrawString ----------------------------------------------------
extern "C" THUMB16
NEWCODE void dll_DrawString(uint16_t font,
                            TEXTID text_id,
                            uint8_t align,
                            int16_t x1,
                            int16_t y1,
                            ...
                            uint32_t pen_color)
{
	...
	TextObject_SetText(textObj, text_id);
...
extern "C" THUMB16
NEWCODE void dll_GC_PutChar(int16_t x, int16_t y, uint16_t width, uint16_t height, IMAGEID imageID)
{
