 ...
 */
#define FSINT32_MAX 0x7FFFFFFF

/**
 * A constant holding the minimum value an FSint32 can have.
 */
#define FSINT32_MIN (-FSINT32_MAX - 1)
 ...
 */
#define FSINT16_MAX 0x7FFF

/**
 * A constant holding the minimum value an FSint16 can have.
 */
#define FSINT16_MIN (-FSINT16_MAX - 1)
