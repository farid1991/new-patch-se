...
typedef struct _MusicApplication_Book
{
	BOOK book;
#ifdef CLEARAUDIO
	void *pIMusicServer;         // 0x18
	...
	uint16_t unk_0x6A;           // 0x6A
	uint8_t unk_0x6C;            // 0x6C
	uint8_t EqPreset;            // 0x6D
	uint8_t unk_0x6E;            // 0x6E
	uint8_t unk_0x6F;            // 0x6F
	int32_t EqBand_63;           // 0x70
	int32_t EqBand_250;          // 0x74
	int32_t EqBand_1000;         // 0x78
	int32_t EqBand_4000;         // 0x7C
	int32_t EqBand_16000;        // 0x80
	uint32_t unk_0x84;           // 0x84
	uint32_t unk_0x88;           // 0x88
