...
public:
    ...
    virtual int InsertTextUTF16(FUint16 *text, int length_text, FSint32 insertIndex);                                // 0x1C Inserts a text run by copy to a IUIRichText object.
    ...
    virtual int SetCharSpacing(TFloat value, FSint32 startIndex, FSint32 endIndex);         // 0x54 0x58 Sets additional spacing between characters.
    ...
    virtual int SetLeftIndent(TFloat value, FSint32 startIndex, FSint32 endIndex);          // 0x74 0x78 Sets the amount the left side of each paragraph in the range is indented.
    virtual int SetLinePaddingAfter(TFloat value, FSint32 startIndex, FSint32 endIndex);    // 0x78 0x7C Sets an amount of extra space to pad after each line.
    virtual int SetLinePaddingBefore(TFloat value, FSint32 startIndex, FSint32 endIndex);   // 0x7C 0x80 Sets an amount of extra space to pad before each line.
    ...
    virtual int SetLineSpacingAmount(TFloat value, FSint32 startIndex, FSint32 endIndex);   // 0x84 0x88 Sets line spacing amount attribute.
    ...
    virtual int SetRightIndent(TFloat value, FSint32 startIndex, FSint32 endIndex);         // 0x94 0x98 Sets the amount the right side of each paragraph in the range is indented.
    virtual int SetSpaceAfter(TFloat value, FSint32 startIndex, FSint32 endIndex);          // 0x98 0x9C
    ...
    virtual int SetWordSpacing(TFloat value, FSint32 startIndex, FSint32 endIndex);                                        // 0xB8 0xBC Sets additional spacing between words.
    ...
    virtual int GetCharSpacing(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *pSpacing);                   // 0xC8
    ...
    virtual int GetIndent(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *pIndent);                         // 0xD4
    ...
    virtual int GetLeftIndent(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *indent_value);                // 0xE8
    virtual int GetLinePaddingAfter(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *line_padding_value);    // 0xEC
    virtual int GetLinePaddingBefore(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *line_padding_value);   // 0xF0
    virtual int GetLineSpacing(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TUILineSpacing *pLineSpacing);       // 0xF4
    virtual int GetLineSpacingAmount(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *pLineSpacingAmount);   // 0xF8
    ...
    virtual int GetRightIndent(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *indent_value);               // 0x108
    virtual int GetSpaceAfter(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *space);                       // 0x10C
    virtual int GetSpaceBefore(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *space);                      // 0x110
    ...
    virtual int GetWordSpacing(FSint32 index, FSint32 *startIndex, FSint32 *endIndex, TFloat *word_spacing);               // 0x12C
};
