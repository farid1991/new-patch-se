...
#define Default_StatusRow_OnRedraw \
    ((void (*)(DISP_OBJ *, int, RECT *, int))ADDR_StatusRow_OnRedraw)

// --- ObEx pages ------------------------------------------------------------

#define pg_ObEx_ReceiveFile \
    ((int (*)(void *, BOOK *))ADDR_pg_ObEx_ReceiveFile)

#define pg_ObEx_SendFile \
    ((int (*)(void *, BOOK *))ADDR_pg_ObEx_SendFile)
#define pg_ObEx_SendMultipleFiles \
    ((int (*)(void *, BOOK *))ADDR_pg_ObEx_SendMultipleFiles)

#define pg_ObEx_FileSent \
    ((int (*)(void *, BOOK *))ADDR_pg_ObEx_FileSent)

#define IsObExSendBook \
    ((int (*)(BOOK *))ADDR_IsObExSendBook)

static const wchar_t output_fmt[] = L"%d/%d KB";

THUMB16 NEWCODE int New_ObEx_ReceiveFile(void *obexdata, BOOK *book)
{
...
THUMB16 NEWCODE int New_ObEx_SendFile(void *data, BOOK *book)
{
...
#if defined(DB3350)
THUMB16 NEWCODE int New_ObEx_SendMultipleFiles(void *data, BOOK *book)
{
...
THUMB16 NEWCODE int New_ObEx_FileSent(void *data, BOOK *book)
{
...
THUMB16 NEWCODE void display_to_statusrow(int current_kb, int total_kb)
{
    wchar_t buffer[32];
...
THUMB16 NEWCODE void New_StatusRow_OnRedraw(DISP_OBJ *disp_obj, int r1, RECT *rect, int r3)
{
#if defined(A1)
