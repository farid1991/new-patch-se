...
THUMB16 NEWCODE int file_list_item_filter(void *elem)
{
    return (elem != NULL);
}

THUMB16 NEWCODE void file_list_remove_item(void *item)
{
...
THUMB16 NEWCODE FILELIST_ELEM *file_list_add_item(wchar_t *filename)
{
...
THUMB16 NEWCODE void file_list_destroy(LIST **flist, void (*free_list)(void *item))
{
    if (*flist)
    {
...
THUMB16 NEWCODE LIST *file_list_create(const wchar_t *path)
{
