...
THUMB16
NEWCODE BOOL FSX_IsFileExists(const wchar_t *fpath, const wchar_t *fname)
{
	FSTAT fs;
...
THUMB16
NEWCODE void _Set_SWF_AsFlashMenu(const wchar_t *fpath, const wchar_t *fname, int *error)
{
...
THUMB16
NEWCODE int FlashMenuPicker_Pick_OnMessage(GUI_MESSAGE *msg)
{
...
THUMB16
NEWCODE void FlashMenuPicker_Pick_Select(BOOK *book, GUI *gui)
{
...
THUMB16
NEWCODE void FlashMenuPicker_Pick_Preview(BOOK *book, GUI *gui)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
	int item = ListMenu_GetSelectedItem(fmbk->sub_menu);
...
THUMB16
NEWCODE void FlashMenuPicker_Pick_Exit(BOOK *book, GUI *gui)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
...
THUMB16
NEWCODE int pg_FlashMenuPicker_Pick_EnterEvent(void *data, BOOK *book)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
...
THUMB16
NEWCODE int pg_FlashMenuPicker_Pick_ExitEvent(void *data, BOOK *book)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
	FREE_GUI(fmbk->sub_menu);
	return 1;
...
THUMB16
NEWCODE void FlashMenuPicker_SelectAction(BOOK *book, GUI *gui)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
...
THUMB16
NEWCODE void FlashMenuPicker_ExitAction(BOOK *book, GUI *gui)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
	FreeBook(&fmbk->book);
}
...
THUMB16
NEWCODE int FlashMenuPicker_onMessage(GUI_MESSAGE *msg)
{
...
THUMB16
NEWCODE int pg_FlashMenuPicker_EnterEvent(void *data, BOOK *book)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
...
THUMB16
NEWCODE int pg_FlashMenuPicker_ExitEvent(void *data, BOOK *book)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
	FREE_GUI(fmbk->main_menu);
	return 1;
...
THUMB16
NEWCODE int pg_FlashMenuPicker_CancelEvent(void *data, BOOK *book)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
	FreeBook(&fmbk->book);
	return 1;
...
THUMB16
NEWCODE void FlashMenuPicker_onClose(BOOK *book)
{
	FlashMenuPickerBook *fmbk = (FlashMenuPickerBook *)book;
	FREE_GUI(fmbk->main_menu);
	FREE_GUI(fmbk->sub_menu);
...
THUMB16
NEWCODE BOOL IsFlashMenuPickerBook(BOOK *book)
{
	return (book->onClose == FlashMenuPicker_onClose);
}

THUMB16
NEWCODE FlashMenuPickerBook *Create_FlashMenuPickerBook()
{
...
THUMB16
NEWCODE void FlashmenuPicker(BOOK *book, GUI *gui)
{
